...
<form action="" method="post">
  ...
  <input type="text" name="ctc" placeholder="CTC" style="padding:5px; font-size:24px; width: 355px; height: 90px; left: 986px; top: 460px; position: absolute; background: white; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border: 1px rgba(0, 0, 0, 0.50) solid" required>
  ...
  <input type="text" name="doj" placeholder="Date of Joining" onblur="(this.type='text')" onfocus="(this.type='date')" style="padding:5px; font-size:24px; width: 355px; height: 90px; left: 986px; top: 600px; position: absolute; background: white; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border: 1px rgba(0, 0, 0, 0.50) solid" required>
  ...
  <input type="submit" name="save_details" value="Submit" style="color:white; font-size:36px; width: 450px; height: 69px; left: 30px; top: 965px; position: absolute; background: #1D8AA1; border-radius: 44px">
</form>
  ...
  <div style="left: 1285px; top: 1003px; position: absolute; color: #1D8AA1; font-size: 24px; font-family: Inter; font-weight: 400; word-wrap: break-word"><a styles="text-decoration:none;" href="employee_database.html">Cancel</div></a>
