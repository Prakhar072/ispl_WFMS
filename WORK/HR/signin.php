...
<body>
 ...
 <div style="width: 1440px; height: 1024px; position: relative; background: white">
  ...
  <a href="https://www.youtube.com/"><div style="left: 462px; top: 609px; position: absolute; color: #1D8AA1; font-size: 24px; font-family: Inter; font-weight: 400; word-wrap: break-word">Forgot Password?</div></a>
  ...
  <!--Login Button-->
  <input style="width: 109px; left: 665px; top: 707px; position: absolute; color: white; font-size: 40px; font-family: Inter; font-weight: 400; word-wrap: break-word; width: 502px; height: 69px; left: 462px; top: 697px; position: absolute; background: #1D8AA1; border-radius: 28px" type="submit" value="Login">
  ...
  <!--email field-->
  <input Style= "font-size:35px; padding-left: 7px; width: 502px; height: 76px; left: 462px; top: 392px; position: absolute; background: white; border: 2px rgba(0, 0, 0, 0.50) solid " type="Text" placeholder="Email">
  <!--password field-->  
  <input Style= "font-size:35px; padding-left: 7px; width: 502px; height: 76px; left: 462px; top: 513px; position: absolute; background: white; border: 2px rgba(0, 0, 0, 0.50) solid " type="password" placeholder="Password">
